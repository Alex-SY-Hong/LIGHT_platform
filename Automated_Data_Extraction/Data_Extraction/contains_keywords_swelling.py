...
# Keyword dictionary for Polymer Properties and Absorption/Swelling Performance
keyword_dict = {
    "Polymers": [
    ...
    "Absorption & Swelling Metrics": [
        # Core metrics: Water absorption, swelling ratio
        "water absorption", "water uptake", "absorption capacity", 
        "swelling ratio", "swelling degree", "swelling percentage",
        "equilibrium swelling", "equilibrium water content", "EWC",
        "swelling capacity", "absorbency", "fluid uptake",
        "swelling index", "dimensional stability", "volume expansion",
        "weight gain", "mass uptake"
    ]
}
...
def contains_keywords(text, keyword_dict):
    ...
    for category, synonyms in keyword_dict.items():
        ...
        for word in synonyms:
            # Use \b to match whole words only, avoiding partial matches
