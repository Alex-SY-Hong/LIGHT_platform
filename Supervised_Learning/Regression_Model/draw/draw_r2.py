...
# ===== Global Unified Parameters (Consistent with Histogram) =====
AX_SPINE_LW = 1.5   # Axis spine line width
TICK_W      = 1.5   # Tick line width
TICK_LEN    = 6     # Tick length
GRID_LW     = 1.0   # Grid line width
MARKER_EDGE = 1.5   # Scatter marker edge width
FIGSIZE     = (6, 6)
DPI         = 500

# ===== Unified Font and Style =====
plt.rcParams.update({
    "axes.labelsize": 20,
    "axes.titlesize": 20,
    "xtick.labelsize": 20,
...
def scatter_train_test(y_tr, yhat_tr, y_va, yhat_va, out_png, log10=False):
    ...
    # ===== Plotting (Style fully matches histogram) =====
    fig, ax = plt.subplots(figsize=FIGSIZE, dpi=DPI)
    ax.set_box_aspect(1)  # ✅ Axis area fixed to square
...
def main():
    ...
    # Linear Version (Keep log10 axis labels)
