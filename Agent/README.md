...
### Run Agent Selection (Final Decision) — select the best formulation ratio and generate the Agent response

### Run ALL (Sequence: 1 → 2 → 3) — automatically run everything in order (1 → 2 → 3)
